...
public class Craig extends Critter {
    ...
    public static String runStats(java.util.List<Critter> craigs) {
        ...
        System.out.println();
        s.append("" + craigs.size() + " total Craigs    ");
        s.append("" + total_straight / (GENE_TOTAL * 0.01 * craigs.size()) + "% straight   ");
        s.append("" + total_back / (GENE_TOTAL * 0.01 * craigs.size()) + "% back   ");
        s.append("" + total_right / (GENE_TOTAL * 0.01 * craigs.size()) + "% right   ");
        s.append("" + total_left / (GENE_TOTAL * 0.01 * craigs.size()) + "% left   ");
        return s.toString();
    }
